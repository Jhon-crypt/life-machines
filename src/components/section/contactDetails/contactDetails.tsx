            ...
            <div className="w-full md:w-1/2 p-4">
                <div className="flex flex-col justify-between h-full">
                    <div className="mb-10 md:max-w-md"><span className="inline-block mb-4 text-sm text-primary font-bold uppercase tracking-widest">Contact Us</span>
                        <h2 className="font-heading mb-6 text-4xl md:text-5xl lg:text-6xl text-accent font-black tracking-tight">Get In Touch!</h2>
                        <p className="text-gray-500 font-bold">Reach out to us today for custom rigs and high performance pcs.</p>
                    </div>
